package jet.hipics21.ui.desktop;
 ...
 * 
 */
public class Hipics21DesktopNut extends AbstractDesktopNut implements DesktopMenuPluginListener, LaunchACMenuPluginListener {
     ...
     */
    public static final Object PROPERTY_MENU_ITEM = new SerializableKey(Hipics21DesktopNut.class, "PROPERTY_MENU_ITEM");
     ...
     */
    @Initializer
    public final void doHipics21DesktopNutInit() throws JETException {
        ...
        this.desktopMenuPlugin.initializeMenu(getMainComponent(), Hipics21MenuConstants.GROUP_MAIN_MENU, Hipics21MenuConstants.MAIN_MENU_BAR);
        ...
        final Hipics21ACLauncher hipics21ACLauncher = new Hipics21ACLauncher(this.launchACMenuPlugin, this.childApplicationComponents, getApplicationComponent());
        getSession().setProperty(ApplicationComponentLauncher.SESSION_KEY, hipics21ACLauncher);
     ...
     */
    @Deinitializer
    public final void doHipics21DesktopNutDeinitialization() throws JETException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            logp(JETLevel.INFO, "Hipics21DesktopNut", "doHipics21DesktopNutDeinitialization", "Deinitializing : " + ac.getName());
    ...
    public void performMenuAction(final ActionModel action, final MenuItemModel menuItemModel) {
        ...
        logp(JETLevel.INFO, "Hipics21DesktopNut", "performMenuAction", action.getId());
